...
def randstr(n):
    return ' '.join(random.choice(word_list) for x in xrange(n))
...
with open('data_10k', 'w') as f:
    output = generate(1e4, 0.5)
    f.write('\n'.join(output))

with open('data_100k', 'w') as f:
    output = generate(1e5, 0.5)
    f.write('\n'.join(output))

with open('data_500k', 'w') as f:
    output = generate(5e5, 0.5)
    f.write('\n'.join(output))
